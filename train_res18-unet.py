...
from unet.Res18UNet import Resnet18_Unet
...
wandb_name = 'res18-unet-pre-untitled'
...
def train_model(
    ...
    for epoch in range(epoch_start, epochs + 1):
        ...
        if save_checkpoint:
            ...
            plot_save_loss(data, savedir=Path(dir_checkpoint), save_fig=False)
            ...
            for i,batch in enumerate(tqdm(test_loader, total=len(test_loader), desc='Test round', unit='batch', leave=True)):
                ...
                image, mask_pred = image.cpu(), mask_pred.cpu()
...
if __name__ == '__main__':
    ...
    model = Resnet18_Unet(n_channels=args.channels, n_classes=args.classes, pretrained=True)
